        ...
        <div>
            <div className='col-lg-6 w-lg-50 w-sm-100 mt-5 border p-5  d-block mx-auto ' style={{ backgroundColor: "rgb(172, 175, 237)" }}>
                <form className='text-center fs-5' onSubmit={handleSubmit(onSubmit)} >
                    ...
                    <input className='mb-4 ms-3 rounded border-0 p-1' type='text' value='name' {...register("name", { required: true })} /> <br />
                    <label> email :</label>
                    <input className='mb-4 ms-3 rounded border-0 p-1' type='text' value='email'  {...register("email", { required: true })} /> <br />
                    ...
                    <input className='mb-4 ms-3 rounded border-0 p-1' type="number" value='phn' {...register("phone")} /> <br />
